	...
	return (
		<div className="space-y-4">
			...
			<div className="flex gap-2">
				...
				<button
					onClick={addSkill}
					className="flex items-center gap-2 px-4 py-2 text-sm bg-blue-600 text-white rounde-lg hover:bg-blue-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
				>
			...
			<div className="bg-blue-50 p-3 rounded-lg">
				<p>
					<strong className="text-blue-800 text-sm">Tip: </strong>Add 8-12 relevant skills. Include both technical skills (programming
